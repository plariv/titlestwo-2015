...
$layout->blocks["top"][] = "details";$page_layouts["search_sellers_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "seller_name";
$arr['viewFormat'] = ViewFormat("seller_name", $strTableName);
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ttl_actions";
$arr['viewFormat'] = ViewFormat("ttl_actions", $strTableName);
$fieldsArr[] = $arr;
...
//seller_name - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"seller_name", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="seller_name")
		$ownerIdValue=$value;
	$xt->assign("seller_name_value",$value);
...
//ttl_actions - 
	...
	$value="";
	$value = ProcessLargeText(GetData($data,"ttl_actions", ""),"","",MODE_VIEW);
	if($mainTableOwnerID=="ttl_actions")
		$ownerIdValue=$value;
	$xt->assign("ttl_actions_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='search_sellers_edit.php?".$editlink."'\"");
