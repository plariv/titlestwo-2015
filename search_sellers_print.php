...
$layout->blocks["top"][] = "pdf";$page_layouts["search_sellers_print"] = $layout;
...
//	seller_name - 
			$value="";
				$value = ProcessLargeText(GetData($data,"seller_name", ""),"field=seller%5Fname".$keylink,"",MODE_PRINT);
			$record["seller_name_value"]=$value;

//	ttl_actions - 
			$value="";
				$value = ProcessLargeText(GetData($data,"ttl_actions", ""),"field=ttl%5Factions".$keylink,"",MODE_PRINT);
			$record["ttl_actions_value"]=$value;
			if($col<$colsonpage)
...
$xt->assign("seller_name_fieldheadercolumn",true);
$xt->assign("seller_name_fieldheader",true);
$xt->assign("seller_name_fieldcolumn",true);
$xt->assign("seller_name_fieldfootercolumn",true);
$xt->assign("ttl_actions_fieldheadercolumn",true);
$xt->assign("ttl_actions_fieldheader",true);
$xt->assign("ttl_actions_fieldcolumn",true);
$xt->assign("ttl_actions_fieldfootercolumn",true);
